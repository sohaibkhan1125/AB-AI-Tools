...
export default function WebpToJpgPage() {
  ...
  const convertToJpg = () => {
    ...
    toast({ title: 'Processing', description: 'Converting your WEBP image to JPG...' });
    ...
    img.onload = () => {
      ...
      if (ctx) {
        // Fill background with white for transparency handling if WEBP has alpha
    ...
    <div className="container mx-auto py-8 px-4">
      <Card className="max-w-3xl mx-auto shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold font-headline">WEBP to JPG Converter</CardTitle>
